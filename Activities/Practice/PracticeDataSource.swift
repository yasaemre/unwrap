...
class PracticeDataSource: NSObject, UITableViewDataSource {
    ...
    var activities: [PracticeActivity.Type] = [FreeCodingPractice.self, PredictTheOutputPractice.self, RearrangeTheLinesPractice.self, SpotTheErrorPractice.self, TapToCodePractice.self]
